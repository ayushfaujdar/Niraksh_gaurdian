		...
		<footer className="footer">
			<div className="footer-left">
				...
				<div className="social-links">
					...
					<a href="https://facebook.com" className="social-link" aria-label="Visit our Facebook page">
						<svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
			...
			<div className="footer-right">
				...
				<p className="support-text">Our support is here for you 24/7</p>
				<div className="contact-info">
					<a href="tel:+123000111222333" className="phone-link">
						<svg
							width="16"
							height="16"
							viewBox="0 0 24 24"
					...
					<a href="mailto:support@medicompare.c" className="email-link">
						<svg
							width="16"
							height="16"
							viewBox="0 0 24 24"
